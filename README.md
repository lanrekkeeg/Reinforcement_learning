# we apply reinforcement  learning on Hand to pick an obstacle placed in surrounding.Hand model is created in Gazebo and ROS is used to control this hand Model.
